...
func TestDiskStorerAll(t *testing.T) {
	...
	d.Set(ctx, testid1, "hello")
	d.Set(ctx, testid2, "friend")
...
func TestDiskStorerDel(t *testing.T) {
	...
	err = d.Del(ctx, testid1)
	if err != nil {
		t.Error(err)
	}

	_, err = d.Get(ctx, testid1)
	if err == nil {
...
func TestDiskStorerCleaner(t *testing.T) {
	...
	//test1
	err = d.Set(ctx, testid1, testid1)
	if err != nil {
		t.Error(err)
	}
	//test2
	err = d.Set(ctx, testid2, testid2)
	if err != nil {
		t.Error(err)
	}
